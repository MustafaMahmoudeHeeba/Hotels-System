...
public class ReservationService {
    ...
    private static final String CREATED_TOPIC = "reservation-created";
    private static final String CANCELLED_TOPIC = "reservation-cancelled";
    ...
    public Reservation createReservation(Reservation reservation) {
        ...
        kafkaTemplate.send(CREATED_TOPIC, ReservationEvent.builder()
    ...
    public void cancelReservation(Long id) {
        ...
        if (reservation != null) {
            kafkaTemplate.send(CANCELLED_TOPIC, ReservationEvent.builder()
